...
public class InvoiceTest {
    ...
    public void testEmptyInvoiceHasEmptySubtotal() {
        Assert.assertThat(BigDecimal.ZERO, Matchers.comparesEqualTo(invoice.getNetPriceTotal()));
    }
    ...
    public void testInvoiceHasTheSameSubtotalAndTotalIfTaxIsZero() {
        ...
        Assert.assertThat(invoice.getTotal(), Matchers.comparesEqualTo(invoice.getNetPriceTotal()));
    }
    ...
    public void testInvoiceHasProperSubtotalForManyProducts() {
        ...
        Assert.assertThat(new BigDecimal("310"), Matchers.comparesEqualTo(invoice.getNetPriceTotal()));
    }
    ...
    public void testInvoiceHasPropoerSubtotalWithQuantityMoreThanOne() {
        ...
        Assert.assertThat(new BigDecimal("50"), Matchers.comparesEqualTo(invoice.getNetPriceTotal()));
    }
